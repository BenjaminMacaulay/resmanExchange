...
import 'bankdetails_sell_model.dart';
export 'bankdetails_sell_model.dart';

class BankdetailsSellWidget extends StatefulWidget {
  const BankdetailsSellWidget({Key? key}) : super(key: key);

  @override
  _BankdetailsSellWidgetState createState() => _BankdetailsSellWidgetState();
}

class _BankdetailsSellWidgetState extends State<BankdetailsSellWidget> {
  late BankdetailsSellModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BankdetailsSellModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<BankDetailsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<BankDetailsRecord> bankdetailsSellBankDetailsRecordList =
            snapshot.data!;
                        ...
                        child: Column(
                          ...
                          children: [
                                  ...
                                  child: Padding(
                                    ...
                                    child: RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: bankdetailsSellBankDetailsRecordList
                                                        .length >
                                                    0
                            ...
                            Builder(
                              builder: (context) {
                                final bankDetails =
                                    bankdetailsSellBankDetailsRecordList
                                        .toList();
                            ...
                            if (bankdetailsSellBankDetailsRecordList.length < 6)
                              Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  InkWell(
