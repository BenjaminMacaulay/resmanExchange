                                          ...
                                          child: Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Expanded(
                                                  child: Text(
                                                    'Before proceeding with the permanent deactivation of your account, please be aware that:\n\nAll pending transactions will be canceled.\n   - Any pending transactions, including withdrawals and buy/sell orders, will be canceled, and they will not be processed.',
                              ...
                              onPressed: () async {
                                if (loggedIn) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Your account has been deleted. You can sign up again to continue your crypto journey.',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
                                          fontSize: 14.0,
